; Commentaire Grace
%define S "; Commentaire Grace%2$c%%define S %3$c%1$s%3$c%2$c%%define D_MAIN global _main%2$c%%define FT _main:%2$csection .data%2$cdata:%2$c.s db S, 0%2$c.fichier db %3$cGrace_kid.s%3$c, 0%2$csection .text%2$cglobal start%2$cextern _dprintf%2$cD_MAIN%2$cstart:%2$cFT%2$cpush rbp%2$cmov rbp, rsp%2$cmov rax, 0x2000005%2$cmov rdi, data.fichier%2$cmov rsi, 0x202%2$cmov rdx, 0x124%2$csyscall%2$cmov rdi, rax%2$cmov rsi, data.s%2$cmov rdx, data.s%2$cmov rcx, 10%2$cmov r8, 34%2$ccall _dprintf%2$cleave%2$cret"
